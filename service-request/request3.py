...
<body>''')
print(f'''<form action="request3.py">
    <div><input type="text" placeholder="Price" name="unp" value="{unp or ''}" /></div>
    <div></div>
    ...
    <div>
        ...
        <input class="button" type="button" onclick="window.location.href = 'request3.py';" value="reset"/>
    </div>
</form>''')
